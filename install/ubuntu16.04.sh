...
" > /etc/apache2/sites-available/001-yours.conf
...
sed -i 's:^$www_dir.*:$www_dir = '/var/www/yours/';:g' /var/www/yours/gosmore.php
sed -i 's:^$yours_dir.*:$yours_dir = '/var/www/gosmore/';:g' /var/www/yours/gosmore.php
